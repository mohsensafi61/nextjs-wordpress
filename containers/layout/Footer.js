...
<footer className="p-4 bg-gray-200 sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
                ...
                <span className="mr-4 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">شهرداری ریز</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">منابع</h2>
                <ul className="text-gray-600 dark:text-gray-400 ">
                    <li className="mb-4">
                        <a href="https://flowbite.com/" className="hover:font-semibold">استانداری بوشهر</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" className="hover:font-semibold">شهرداری بوشهر</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/flowbite" className="hover:font-semibold ">آدرس : ریز جنب بانک صادرات</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:font-semibold">riz@yahoo.com</a>
                    </li>
                </ul>
            </div>
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">پیوند ها</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="#" className="hover:font-semibold">شهرسازی و درامد</a>
                    </li>
                    <li>
                        <a href="#" className="hover:font-semibold">شرایط و ضوابط</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">تمام حقوق این وبسایت متعلق به شهرداری ریز می باشد
        </span>
        <div dir="ltr" className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
